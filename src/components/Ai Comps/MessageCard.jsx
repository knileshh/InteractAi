        ...
        <div className={`max-w-2xl mx-auto my-4 p-4 rounded-lg shadow-md ${isAssistant ? 'bg-red-100' : 'bg-blue-100'}`}>
            <div className="flex items-center mb-2">
                <div className={`w-8 h-8 rounded-full ${isAssistant ? 'bg-white-300' : 'bg-blue-300'} mr-2`}>
                    {isAssistant ? <img src="https://res.cloudinary.com/dg1sjqoxg/image/upload/v1735500888/OnlyLogo_alzoct.png" alt="Avatar" /> : <img src="https://res.cloudinary.com/dg1sjqoxg/image/upload/v1735500583/avatar_saga4w.png"/>}
                </div>
