const people = [
    ...
    },
    {
        ...
        role: 'Co-Founder / CEO',
        imageUrl:
            'https://plus.unsplash.com/premium_photo-1675096939530-e804e37b9b65?q=80&w=1911&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    },
    // More people...
]
            ...
            <div className="mx-auto grid max-w-7xl gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-3">
                <div className="max-w-2xl">
                    ...
                    <p className="mt-6 text-lg leading-8 text-gray-600">
                        We love creating application that help boost your productivity because "A second saved is a second earned"
                    </p>
                </div>
